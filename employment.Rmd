...
# Supported Employment `r emo::ji("star")` `r emo::ji("pencil")`
...
### Which best describes your current housing situation? `r emo::ji("pencil")`
...
### Paid Job or Paid Internship `r emo::ji("pencil")`
...
### Unpaid Position or Volunteer `r emo::ji("pencil")`
...
### For this survey, household size is determined by the number of people you purchase and prepare food with. This may or may not include your roommate(s). How many people are in your household who purchase and prepare food with you? `r emo::ji("pencil")`
...
### How much is your household's gross monthly income (before taxes and not including financial aid)? `r emo::ji("pencil")`
...
### Do you receive Supplemental Security Income (SSI)* in California? `r emo::ji("pencil")`
...
### Does anyone in your household get more than half (11 or more) of their meals per week from another source (e.g. university meal plan)? `r emo::ji("pencil")`
...
### What type of health insurance do you currently have? `r emo::ji("pencil")`
...
84.5% (n = 120) of respondents reported that they pay \$0 a week on cigarettes and tobacco, 5.6% (n = 8) reported they pay less than \$10 a week, and 6.3% (n = 9) reported they pay \$10-\$49 a week.
