...
```{r}
table(tolower(bns$matriculation_date)) %>% kable(col.names = c("matriculation_date", "Frequency")) %>% kable_styling() %>% scroll_box(width = "500px", height = "500px")
```
...
```{r}
table(tolower(bns$exp_grad_date)) %>% kable(col.names = c("exp_grad_date", "Frequency")) %>% kable_styling() %>% scroll_box(width = "500px", height = "500px")
```
