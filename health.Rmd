...
plot_xtab(x=bns$MH1_1, grp=bns$D4, margin="col", show.total = FALSE) + 
          xlab("# of Days") + ylab("Percent (count)") + 
          theme(legend.position="top", legend.title=element_blank()) 

```
*Two respondants selected Gender Queer or Gender-Nonconforming
*One respondant selected Gender Unlisted
