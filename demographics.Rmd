...
Most respondants, or 70.7%, (n = 106) reported that they were Female at birth and 29.3% of the respondents (n = 44) were Male at birth.
...
Most respondants, or 69.3 % of the respondents, identify as a Woman (n = 104), 28.7% identify as a Man (n = 43), and lastly 1.3% (n = 2) identify as Gender Queer or Gender-Nonconforming.
...
```{r}
names(identifier) <- c("Transfer student",
...
```{r}
multi.table(identifier) %>% kable(col.names = c("n", "%")) %>% kable_styling()
```
