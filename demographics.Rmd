...
#bns$units_relevel[bns$units_relevel < 12] <- "< 12"
#bns$units_relevel[bns$units_relevel <= 15 & bns$units_relevel > 12] <- "13-15"
#plot_frq(bns$units_relevel, ylim = c(0,60)) + xlab("Units Enrolled")
```

When looking at the graph above, the majority of students (30.2% n = 45) are enrolled in 15 units, the next highest count is 24.2% (n = 36) being enrolled in 12 units. 
...
Out of the students who said they are enrolled at more than one college, 25.0% (n = 2) reported that they are enrolled in 12 units outside of CSU Chico, 25.0% (n = 2) reported that they are enrolled in 13 units outside of CSU Chico, and 1 student (12.5%) each reported that they are taking 1, 3, 10, and 15 units outside of CSU Chico respectively.
